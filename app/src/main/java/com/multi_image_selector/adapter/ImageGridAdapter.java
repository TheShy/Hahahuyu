...
//            indicator = (ImageView) view.findViewById(R.id.checkmark);
            indicator = (TextView) view.findViewById(R.id.tv_checkmark);
...
//                    mask.setVisibility(View.VISIBLE);
                    ...
                    int num = getPositionByDataFromList(mSelectedImages,data)+1;
                    if (num > 0) {
...
//                    mask.setVisibility(View.GONE);
            ...
            if (imageFile.exists()) {
                // 显示图片
                Log.i("robin", imageFile.getAbsolutePath());
                Glide.with(mContext)
                        .load(imageFile)
        ...
        private int getPositionByDataFromList(List<Image> originalList,Image data){
            for (int i = 0,size = originalList.size(); i < size; i++) {
                Image image = originalList.get(i);
