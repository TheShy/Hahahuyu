package com.touyuanren.hahahuyu.manage;
...
//    }
    ...
    public static void setImageViewBitmap(final Context context, final String url, final ImageView imageView) {
        ...
        Glide.with(context).load(url).asBitmap().placeholder(R.drawable.ic_launcher).into(new BitmapImageViewTarget(imageView) {
            @Override
            protected void setResource(Bitmap resource) {
