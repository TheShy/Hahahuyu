package com.touyuanren.hahahuyu.utils.newapp;
...
public class CheckVersionInfoTask extends AsyncTask<Void, Void, String> {
    ...
    private static final String VERSION_INFO_URL = HttpApi.ROOT_PATH + HttpApi.VERSION;
    ...
    private void parseJson(String result) {
        try {
            ...
            String apkUrl = obj.getString("download_url");                 //APK下载路径
            String updateMessage = obj.getString("v_note");//版本更新说明
            int apkCode = obj.getInt("v_code");              //新版APK对于的版本号
            ...
            if (status.equals("1")){
                //对比版本号判断是否需要更新
                Toast.makeText(mContext, mShowProgressDialog+"", Toast.LENGTH_SHORT).show();
