...
import com.touyuanren.hahahuyu.ui.activity.account.NotificationUpdateActivity;
...
public class DownloadService extends Service {
	...
	// 返回的安装包url
	private String apkUrl = "http://www.momohudong.com/app/momohudong.apk";
	// private String apkUrl = MyApp.downloadApkUrl;
	/* 下载包安装路径 */
	private static final String savePath = "/sdcard/updateApkDemo/";

	private static final String saveFileName = savePath + "momohudong.apk";
