...
public class PubLoopImgAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<String> list;
    private OnItemClickListener listener;

    public PubLoopImgAdapter(List<String> list) {
        this.list = list;
    }
    ...
    public interface OnItemClickListener {
        void onItemClick(View parent, int type, int position);
    }
