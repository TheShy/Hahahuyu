...
public class HotAdapter extends BaseAdapter {
    ...
    ArrayList<HotBean.DataBean> mList;
    LayoutInflater inflater;
    Context context;

    //控制数据从外部传入
    public HotAdapter(Context context, ArrayList<HotBean.DataBean> mList) {
        this.mList = mList;
        this.context = context;
        this.inflater = LayoutInflater.from(context);
    }

    public void onDateChange(ArrayList<HotBean.DataBean> mList) {
        this.mList = mList;
