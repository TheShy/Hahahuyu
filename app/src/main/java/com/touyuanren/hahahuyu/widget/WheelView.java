...
public class WheelView extends View {
    ...
    private synchronized void drawList(Canvas canvas) {
        ...
        try {
            ...
            L.i(TAG, "drawList Exception:" + e.getMessage());
        }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        maskHeight = attribute.getDimension(R.styleable.WheelView_maskHight, 48.0f);
    ...
    private class ItemObject {
        ...
        public void drawSelf(Canvas canvas, int containerWidth) {
            ...
            if (isSelected()) {
                ...
                float textSize = normalFont + ((selectedFont - normalFont) *
                        (1.0f - moveToSelect / (float) unitHeight));
